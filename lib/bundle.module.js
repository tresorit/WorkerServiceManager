...
class MultiRemoteService {
    constructor(serviceMap, portFactory, proxyType, maxPorts, minPorts = 0, messageTransformer = new DefaultMessageTransformer(), reuseRemotes = true) {
        ...
        this.messageTransformer = messageTransformer;
        this.reuseRemotes = reuseRemotes;
        this.busyPorts = [];
        this.freePorts = [];
        this.queue = [];
    }
...
export { WorkerServiceManager, AutoTransferrableMessageTransformer, DefaultMessageTransformer, MultiRemoteService, AsyncPortHandler, BasicPortHandler, LazyPortHandler, WorkerGlobalPortHandler, RemoteService };
