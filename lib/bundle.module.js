...
class PortHandler {
    constructor(portPromise, messageTransformer, targetOrigin) {
    ...
    async postMessage(msg, transferables, origin) {
        const port = this.port ? this.port : await this.portPromise;
...
export { WorkerServiceManager, MultiRemoteService, RemoteService, PortHandler };
